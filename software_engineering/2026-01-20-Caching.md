...
Caching is a specific data replication technique that offers best effor guarantees [2].
In this note, we will birefly discuss the following appraoches to caching:
