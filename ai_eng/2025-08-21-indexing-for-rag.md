...
Qubit note <a href="2025-05-03-retrieval-augmented-generation.md">Retrieval Augmented Generation (RAG)</a> discussed the RAG pattern
and its basic usage. However often this is not enough. Although relevant data exist in the database, we may notice inaccurate answers.
Most of the time we can attribute these inacurrasies to one or to any combination of the following inefficiencies [1]:
...
We know from <a href="2025-05-03-retrieval-augmented-generation.md">Retrieval Augmented Generation (RAG)</a>
...
Generating high quality answers depends on the relevance and accuracy of the text retrieved from the database.
...
We have already hinted about the splitting strategy; the granularity of the chunks will affect the retrieval accuracy.
